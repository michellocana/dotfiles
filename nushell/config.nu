...
def lh [fz, lh] { $lh / $fz | math round -p 2 | into string | clip }
...
# Git
def gcm [] { git rev-parse --abbrev-ref HEAD | str trim | split column / | format '{column1}({column2}):' | get 0 | clip }
...
# Misc
def kill [process] { taskkill /f /im $process }
